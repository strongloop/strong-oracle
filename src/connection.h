...
public:
  static void Init(Handle<Object> target);
  static Handle<Value> New(const uni::FunctionCallbackInfo& args);
  static Handle<Value> GetInfo(const uni::FunctionCallbackInfo& args);
  static Handle<Value> Close(const uni::FunctionCallbackInfo& args);

  static Persistent<FunctionTemplate> connectionPoolConstructorTemplate;

  static Handle<Value> GetConnectionSync(const uni::FunctionCallbackInfo& args);
  static Handle<Value> GetConnection(const uni::FunctionCallbackInfo& args);
